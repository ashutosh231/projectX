...
//   return (
//     <section className="relative z-0 w-full h-screen flex flex-col md:flex-row items-center justify-between bg-richblack-900 text-white overflow-hidden px-6 md:px-16">
//       {/* Parallax Background */}
...
//       {/* Left Section */}
//       <div className="w-full md:w-1/2 flex flex-col justify-center space-y-6 animate-fade-in z-0">
    ...
    <section className="relative z-10 w-full h-screen flex flex-col md:flex-row items-center justify-between bg-richblack-900 text-white overflow-hidden px-6 md:px-16">
      ...
      <div className="w-full md:w-1/2 grid grid-cols-2 gap-6 p-6 md:p-12 relative z-10">
        {[
          ...
          <div
            key={idx}
            className={`relative group overflow-hidden rounded-3xl shadow-lg transform transition duration-200 hover:scale-105 hover:shadow-2xl animate-stagger delay-${idx * 50}`}
          >
            <img
              src={img}
              alt={`Destination ${idx + 1}`}
              className="w-full h-64 object-cover rounded-3xl transition-transform transform group-hover:scale-110 animate-float-fast"
            />
            <div className="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500 flex items-end justify-center p-6 text-white text-lg font-bold">
              Explore More
            </div>
