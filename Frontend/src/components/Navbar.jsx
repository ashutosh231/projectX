...
import { GiHamburgerMenu } from "react-icons/gi"; // Added missing import
              ...
              <ul className="absolute right-0 top-full mt-2 w-48 bg-white text-black rounded-md shadow-lg overflow-hidden animate-fadeIn">
                ...
                <li>
                  <button
                    ...
                    className="w-full text-left px-4 py-2 hover:bg-red-500 hover:text-white transition duration-300"
                  >
                    Logout
                  </button>
                </li>
